...
class AbstractFactoryImplSingleton implements AbstractFactory {
  static AbstractFactoryImplSingleton? _instance;
  AbstractFactoryImplSingleton._internal();

  static AbstractFactoryImplSingleton get instance {
    _instance ??= AbstractFactoryImplSingleton._internal();
    return _instance!;
  }
